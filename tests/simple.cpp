...
TEST(Simple, SingleDouble)
{
    const uint8_t data[10] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf0, 0x3f, 0x0f, 0x08};
...
TEST(Simple, SingleString)
{
    const uint8_t data[23] = {0x12, 0x68, 0x65, 0x6C, 0x6C, 0x6F, 0x20, 0x66,
        0x6C, 0x65, 0x78, 0x62, 0x75, 0x66, 0x66, 0x65, 0x72, 0x73, 0x21, 0x00,
        0x13, 0x14, 0x01};
...
TEST(Simple, SimpleVector)
{
    const uint8_t data[22] = {0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x00, 0x0A, 0x00, 0x01, 0x00, 0x06, 0x06, 0x06, 0x0F,
        0x2A, 0x01};
...
{
    const uint8_t data[19] = {0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x00, 0x0A, 0x00, 0x01, 0x00, 0x0C, 0x2E, 0x01};
...
{
    const uint8_t data[19] = {0x66, 0x6F, 0x6F, 0x00, 0x03, 0x62, 0x61, 0x72,
        0x00, 0x01, 0x0A, 0x01, 0x01, 0x01, 0x09, 0x14, 0x02, 0x24, 0x01};
