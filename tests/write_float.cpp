...
INSTANTIATE_TEST_SUITE_P(WriteFloat, WriteF32Fixture,
    testing::Values(WriteF32Params{PI_VALUE, direct_e::direct,
                        {0xdb, 0x0f, 0x49, 0x40, 0x0e, 0x04}, 4},
        WriteF32Params{PI_VALUE, direct_e::indirect,
...
INSTANTIATE_TEST_SUITE_P(WriteFloat, WriteF64Fixture,
    testing::Values(
        WriteF64Params{PI_VALUE, direct_e::direct,
            {0x18, 0x2d, 0x44, 0x54, 0xfb, 0x21, 0x09, 0x40, 0x0f, 0x08}, 8},
        WriteF64Params{PI_VALUE, direct_e::indirect,
...
TEST_P(WriteVecF32Fixture, WriteAndRead)
{
    ...
    ASSERT_TRUE(flexi_write_typed_vector(&m_writer, ex_values.data(),
        ex_values.size()));
    ASSERT_TRUE(flexi_write_finalize(&m_writer));
...
INSTANTIATE_TEST_SUITE_P( //
    ...
    testing::Values( //
        ...
        WriteVecF64Params{{1.0, -2.0, PI_VALUE, -1e4, 1e-5},
